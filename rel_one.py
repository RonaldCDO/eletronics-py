...
I_r1 = current_divisor(I_1, R_1, equivalent_resistor(R_2, R_3))
I_r2 = current_divisor(I_1, R_2, equivalent_resistor(R_1, R_3))
I_r3 = current_divisor(I_1, R_3, equivalent_resistor(R_2, R_1)) 
